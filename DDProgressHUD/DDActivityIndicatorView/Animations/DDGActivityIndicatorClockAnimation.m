//
//  DDGActivityIndicatorClockAnimation.m
...
CGFloat const DDGLengthOfHandRatio = 0.618f;
/**@brief The Radius of cap*/
CGFloat const DDGCapRadius = 1.5f;

@implementation DDGActivityIndicatorClockAnimation
...
- (void)setupAnimationInLayer:(CALayer *)layer withSize:(CGSize)size tintColor:(UIColor *)tintColor{
    ...
    //miniteHand
    CGFloat miniteHandLayerLength = secondHandLayerLength * DDGLengthOfHandRatio;
    ...
    capLayer.frame = CGRectMake(size.width / 2 - DDGCapRadius, size.height / 2 - DDGCapRadius, DDGCapRadius * 2, DDGCapRadius * 2);
    UIBezierPath *path = [UIBezierPath bezierPathWithRoundedRect:capLayer.bounds cornerRadius:DDGCapRadius];
    capLayer.path = path.CGPath;
    capLayer.cornerRadius = DDGCapRadius;
